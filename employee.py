...
class EmployeeSystem:
    def __init__(self,root):
        ...
        btn_search=Button(Frame1,text="Search",command=self.search,font=("times new roman",20),bg="blue",fg="white").place(x=440,y=72,height=30)
        ...
        title3=Label(Frame2,text="Employee Salary Deatils",font=("times new roman",20),bg="lightgray",fg="black",anchor="w",padx=10).place(x=0,y=0,relwidth=1)
        ...
        self.btn_update=Button(Frame2,text="Update",state=DISABLED,command=self.update,font=("times new roman",20),bg="purple",fg="white")
        ...
        title_sal=Label(sal_Frame,text="Salary Slip",font=("times new roman",20),bg="lightgray",fg="black",anchor="w",padx=10).place(x=0,y=0,relwidth=1)
    ...
    def search(self):
        try:
            ...
            if row == None:
                ...
                file_= open('salary_reciept/'+str(row[23]),'r') #yaha par 'r' read mode ko display kar raha h
    ...
    def add(self):
        if self.var_emp_code.get()=='' or self.var_net_salary.get()=='' or self.var_name.get()=='':
            ...
            try:
                ...
                #print(row)
                if row != None:
                    messagebox.showerror("Error","This Employee ID has already exist,try again with another ID",parent=self.root)
                else:
                    ...
                    (
                        ...
                        #101.txt  sara data jakar salary reciept wale folder me save ho jayega text file k format me  
                    )   
                    )
                    con.commit()
                    con.close()
                    ...
                    file_.close()
                    messagebox.showinfo("Success","Record Added Seuucessfully")
                    self.btn_print.config(state=NORMAL)
        ...
        if self.var_emp_code.get()=='' or self.var_net_salary.get()=='' or self.var_name.get()=='':
            ...
            try:
                ...
                if row == None:
                    ...
                    file_.write(self.txt_salary_recipt.get('1.0',END))
                    file_.close()
                    messagebox.showinfo("Success","Record Updated Seuucessfully")
